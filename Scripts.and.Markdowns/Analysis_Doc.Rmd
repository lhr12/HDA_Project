...
r.squaredGLMM(early.chla.model3.5)
#r2m = 0.1058, r2c= 0.1058
#all remaining variables significant
plot(early.chla.model3.5)
anova(early.chla.model3, early.chla.model3.2, early.chla.model3.3, 
      early.chla.model3.4, early.chla.model3.5) #lowest AIC model 3, but model 5 is is only 0.7 higher
coefficients(early.chla.model3.5)


#Saving the fitted values to the dataframe
LAGOS.MN.processed.Early$LMER_Early_Chla <- fitted(early.chla.model3.5)
#should this be the simplest model or the full model? FRA: The simplest model
...
anova(early.secchi.model3, early.secchi.model3.2, early.secchi.model3.3,
      early.secchi.model3.4, early.secchi.model3.5) #lowest AIC model 5
r.squaredGLMM(early.secchi.model3.5) #16% of the variability is explained by the variance of ecoregion
#r2m = 0.1081, r2c = 0.2648
coefficients(early.secchi.model3.5)
...
#remaining variables significant
anova(prime.chla.model3, prime.chla.model3.2, prime.chla.model3.3) #AIC lowest model 3
plot(prime.chla.model3.3)
r.squaredGLMM(prime.chla.model3.3) #9% of the variability is explained by the variance of ecoregion
#r2m = 0.1665, r2c = 0.2513
coefficients(prime.chla.model3.3)
...
anova(prime.secchi.model3, prime.secchi.model3.2) #AIC lowest full model, but only difference of 1 for model 2
r.squaredGLMM(prime.secchi.model3.2) #28% of the variability is explained by the variance of ecoregion
#r2m = 0.1241 r2c = 0.4032
coefficients(prime.secchi.model3.2)
...
#all remaining variables significant
anova(late.chla.model3, late.chla.model3.2, late.chla.model3.3, late.chla.model3.4) #AIC lowest model 4
plot(late.chla.model3.4)
r.squaredGLMM(late.chla.model3.4) #8% of the variability is explained by the variance of ecoregion
#r2m = 0.1515 r2c = 0.2314
coefficients(late.chla.model3.4)
...
coefficients(late.secchi.model3.2)
...
anova(late.secchi.model3, late.secchi.model3.2, late.secchi.model3.3, 
      late.secchi.model3.4, late.secchi.model3.5) #AIC lowest model 5
r.squaredGLMM(late.secchi.model3.5) #3% of the variability is explained by the variance of ecoregion
#r2m = 0.1595 r2c= 0.1889
coefficients(late.secchi.model3.5)
