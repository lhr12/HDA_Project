...
early.model.variables <- LAGOS.MN.processed.Early %>%
  select(chla, secchi, Water.pct, Urban.pct, Undeveloped.pct,Ag.pct,  LakeIWS.Ratio, US_L3NAME)
...
corrplot.mixed(cor(LAGOS.MN.processed.Early[,c(9:15)]))
corrplot.mixed(cor(LAGOS.MN.processed.Prime[,c(9:15)]))
corrplot.mixed(cor(LAGOS.MN.processed.Late[,c(9:15)]))
...
bestNormalize(LAGOS.MN.processed.Early$Water.pct)
...
bestNormalize(LAGOS.MN.processed.Early$Urban.pct)
