...
secchiplot1.Early.MN <- ggplot() +
  geom_sf(data = MN.Ecoregions.sf_UTM, aes(fill = Ecoregion)) +
  geom_sf(data = LAGOS.MN.Summary.Early.sf, 
          aes(size = IntenseUrban.pct, color = secchi.mean),
...
print(secchiplot1.Early.MN)

chlaplot1.Early.MN <- ggplot() +
  geom_sf(data = MN.Ecoregions.sf_UTM, aes(fill = Ecoregion)) +
  geom_sf(data = LAGOS.MN.Summary.Early.sf, 
          aes(size = IntenseUrban.pct, color = chla.mean),
          alpha = 0.4, show.legend = "point") +
  scale_color_viridis_c(option = "inferno") +
  labs(color = "Average \n Chla \n (mg/L)", 
       size = "Intense Urban \n Area \n %") +
...
secchiplot1.Prime.MN <- ggplot() +
  ...
  theme(legend.position = "right", legend.text = element_text(size = 7),
        legend.title = element_text(size = 8),
        legend.margin = margin(0,0,0,0)) 
print(secchiplot1.Prime.MN)

chlaplot1.Prime.MN <- ggplot() +
  geom_sf(data = MN.Ecoregions.sf_UTM, aes(fill = Ecoregion)) +
  geom_sf(data = LAGOS.MN.Summary.Prime.sf, 
          aes(size = IntenseUrban.pct, color = chla.mean),
          alpha = 0.4, show.legend = "point") +
