...
```{r}
# What is sapply(LAGOS.MN.processed, summary) doing?
...
ggplot(LAGOS.MN.processed, aes(x = secchi, y = Natural.pct, color = DOY)) +
  scale_color_viridis_c(option = "plasma") +
  geom_point()
...
ggplot(LAGOS.MN.processed, aes(x = chla, y = Natural.pct, color = DOY)) +
  scale_color_viridis_c(option = "plasma") +
  geom_point()
...
ggplot(LAGOS.MN.processed, aes(x = secchi, y = Natural.pct, color = Month)) +
  scale_color_viridis_c(option = "plasma") +
  geom_point()
...
ggplot(LAGOS.MN.processed, aes(x = chla, y = Natural.pct, color = Month)) +
  scale_color_viridis_c(option = "plasma") +
  geom_point()
...
ggplot(LAGOS.MN.processed.January, aes(x = Natural.pct, y = chla)) +
geom_point() +
...
ggplot(LAGOS.MN.processed.February, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.March, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.April, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.May, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.June, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.July, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.August, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.Sept, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.Oct, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.Nov, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.Dec, aes(x = Natural.pct, y = chla)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("Chla")) +
...
ggplot(LAGOS.MN.processed.January, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
...
ggplot(LAGOS.MN.processed.February, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.March, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.April, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.May, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.June, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.July, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.August, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.Sept, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.Oct, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.Nov, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
ggplot(LAGOS.MN.processed.Dec, aes(x = Natural.pct, y = secchi)) +
geom_point() +
geom_smooth(method=lm) +
xlab(expression("Natural %")) +
ylab(expression("secchi")) +
...
#Maybe use means and not so many data for each lake.

secchiplot.MN <- ggplot() +
geom_sf(data = states.MN, fill = "white")+
geom_sf(data = LAGOS.MN.processed.sf, aes(size = Urban.pct, color = secchi),
...
chlaplot.MN <- ggplot() +
geom_sf(data = states.MN, fill = "white")+
geom_sf(data = LAGOS.MN.processed.sf, aes(size = Urban.pct, color = chla),
alpha = 0.7, show.legend = "point")+
scale_color_viridis_c(option = "inferno") +
labs(color = "chla", size = "Urban \n Area \n %") +
theme(legend.position = "right", legend.text = element_text(size = 7),
legend.title = element_text(size = 8),
legend.margin = margin(0,0,0,0)) 
#+guides(color = F) # This line removes the color gradient
