...
##selecting 2006 lulc
LAGOSiws2006.Ohio <- LAGOSiws.Ohio %>% select(-c("iws_nlcd1992_ha_0":"iws_nlcd2001_pct_95"), -c("iws_nlcd2011_ha_0":"iws_nlcd2011_pct_95"))
```
...
LAGOSiws.nutrient.2006.Ohio <-  left_join(LAGOSnutrient2006.skinny, LAGOSiws2006.Ohio, by = c("lagoslakeid", "state_zoneid"))
```
...
ggplot(LAGOSiws.nutrient.2006.Ohio, aes(x = sampledate, y = tn, color = lagoslakeid)) +
  scale_color_viridis_c(option = "plasma") +
geom_line() 

ggplot(LAGOSiws.nutrient.2006.Ohio, aes(x = sampledate, y = tp, color = lagoslakeid)) +
  scale_color_viridis_c(option = "plasma") +
geom_line() 
