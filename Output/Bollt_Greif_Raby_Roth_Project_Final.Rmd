...
library(knitr)
kable(Variables.table, caption = "Data structure, including variables, descriptions, units, and variable types.")
```
...
```{r echo=FALSE, warning=FALSE, fig.height = 2, fig.width = 3.3, fig.cap = "Early Season log Chlorophyll a vs. Lake IWS Ratio and Mixed Effects Model"}
...
```{r echo=FALSE, warning=FALSE, fig.height = 2, fig.width = 3.3, fig.cap = "Early Season log Secchi Depth vs. Lake IWS Ratio and Mixed Effects Model"}
...
```{r echo=FALSE, warning=FALSE, fig.height = 2, fig.width = 3.3, fig.cap = "Prime Season log Chlorophyll a vs. Lake IWS Ratio and Mixed Effects Model"}
...
```{r echo=FALSE, warning=FALSE, fig.height = 2, fig.width = 3.3, fig.cap = "Prime Season log Secchi Depth vs. Lake IWS Ratio and Mixed Effects Model"}
...
```{r echo=FALSE, warning=FALSE, fig.height = 2, fig.width = 3.3, fig.cap = "Late Season log Chlorophyll a vs. Lake IWS Ratio and Mixed Effects Model"}
...
```{r echo=FALSE, warning=FALSE, fig.height = 2, fig.width = 3.3, fig.cap = "Late Season log Secchi Depth vs. Lake IWS Ratio and Mixed Effects Model"}
