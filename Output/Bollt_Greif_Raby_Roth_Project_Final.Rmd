...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted correctly. In Table 8 are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on early season chlorophyll a. 
...
In Figure 11 is shown Early Season log Chlorophyll a vs. Lake IWS Ratio together with the Mixed Effects Model that we determined.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In Table 10 are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on early season secchi depth.
...
In Figure 12 is shown Early Season log Secchi Depth vs. Lake IWS Ratio together with the Mixed Effects Model that we determined.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In Table 12 are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on prime season chlorophyll a.
...
In Figure 13 is shown Prime Season log Chlorophyll a vs. Lake IWS Ratio together with the Mixed Effects Model that we determined.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In Table 14 are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on prime season secchi depth.
...
In Figure 14 is shown Prime Season log Secchi Depth vs. Lake IWS Ratio together with the Mixed Effects Model that we determined.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In Table 16 are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on late season chlorophyll a.
...
In Figure 15 is shown Late Season log Chlorophyll a vs. Lake IWS Ratio together with the Mixed Effects Model that we determined.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In Table 18 are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on late season secchi.
...
In Figure 16 is shown Late Season log Secchi Depth vs. Lake IWS Ratio together with the Mixed Effects Model that we determined.
