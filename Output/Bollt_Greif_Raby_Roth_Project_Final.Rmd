...
FINAL: ADD Coef table (Analysis_Results.docx)

Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted correctly. In table NNNNNN are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on early season chlorophyll a.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In table NNNNNN are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on early season secchi depth.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In table NNNNNN are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on prime season chlorophyll a.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In table NNNNNN are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on prime season secchi depth.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In table NNNNNN are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on late season chlorophyll a.
...
Since the outcome variable of the model is log transformed, the coefficients must be exponentiated to be interpreted. In table NNNNNN are presented the percentage increase or decrease that a 1% increase of the explanatory variables have on late season secchi.
