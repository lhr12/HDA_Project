...
FINAL: ADD Coef table (Analysis\_Results.docx)
...
NNNNNN are presented the percentage increase or decrease that a 1\%
increase of the explanatory variables have on early season chlorophyll
a.

FINAL: ADD Coef table (Analysis\_Results.docx)

In figure NNNNNN is shown Early Season log Chlorophyll a vs.~Lake IWS
Ratio together with the Mixed Effects Model that we determined.
...
Since the outcome variable of the model is log transformed, the
coefficients must be exponentiated to be interpreted. In table NNNNNN
are presented the percentage increase or decrease that a 1\% increase of
the explanatory variables have on early season secchi depth.

FINAL: ADD Coef table (Analysis\_Results.docx)

In figure NNNNNN is shown Early Season log Secchi Depth vs.~Lake IWS
Ratio together with the Mixed Effects Model that we determined.
...
coefficients must be exponentiated to be interpreted. In table NNNNNN
are presented the percentage increase or decrease that a 1\% increase of
the explanatory variables have on prime season chlorophyll a.

FINAL: ADD Coef table (Analysis\_Results.docx)

In figure NNNNNN is shown Prime Season log Chlorophyll a vs.~Lake IWS
Ratio together with the Mixed Effects Model that we determined.
...
coefficients must be exponentiated to be interpreted. In table NNNNNN
are presented the percentage increase or decrease that a 1\% increase of
the explanatory variables have on prime season secchi depth.

FINAL: ADD Coef table (Analysis\_Results.docx)

In figure NNNNNN is shown Prime Season log Secchi Depth vs.~Lake IWS
Ratio together with the Mixed Effects Model that we determined.
...
coefficients must be exponentiated to be interpreted. In table NNNNNN
are presented the percentage increase or decrease that a 1\% increase of
the explanatory variables have on late season chlorophyll a.

FINAL: ADD Coef table (Analysis\_Results.docx)

In figure NNNNNN is shown Late Season log Chlorophyll a vs.~Lake IWS
Ratio together with the Mixed Effects Model that we determined.
...
coefficients must be exponentiated to be interpreted. In table NNNNNN
are presented the percentage increase or decrease that a 1\% increase of
the explanatory variables have on late season secchi.

FINAL: ADD Coef table (Analysis\_Results.docx)

In figure NNNNNN is shown Late Season log Secchi Depth vs.~Lake IWS
Ratio together with the Mixed Effects Model that we determined.
