...
###Dependent Variables: 
* Secchi Depth (m): This variable measures the visibility of the water column, by using a secchi disk. Its units are meters. Along with chlorophyll a concentration, secchi depth is one of two dependent variables in our study; we are considering it a proxy of water quality, with higher secchi depth measurements indicating good water quality and lower secchi depth measurements indicating impaired water quality. We will be using secchi depth to test research questions 1+2.

* Chlorophyll a (μg/L): This variable measures the chlorophyll a concentration in a water quality sample. Its units are μg/L. Along with secchi depth, chlorophyll a concentration is one of two dependent variables in our study; we are considering it a proxy of water quality, with lower chlorophyll a concentrations indicating good water quality and higher chlorophyll a concentrations indicating impaired water quality. We will be using chlorophyll a it to test research questions 1+2.

###Independent Variables:
We are testing our hypotheses surrounding varying land use by comparing secchi depth and chlorophyll a concentration by land use/land cover. We are using 2011 USGS land use/land cover information as it is listed in LAGOSNE. For more information about the USGS's 2011 classification scheme, visit
...
* Season of data collection: Early (May 15 and Before), Prime (May 16 - September 30), and Late (October 1 and later). These season designations are somewhat arbitrary, but are based off of our prior knowledge of when the prime biological growing season occurs in Minnesota.
